...
<section>
    ...
    <div class="page-heading">
        <ul class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo U('admin/pay/index');?>">支付管理</a>
            </li>
                    ...
                    <header class="panel-heading">
                        支付方式列表
                            <span class="tools pull-right">
                                <a href="<?php echo U('admin/pay/add');?>" class="btn btn-success btn-link">新增支付方式</a>
                            </span>
                    </header>
                    <div class="panel-body">
                        ...
                        <div class="adv-table text-center">
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                                ...
                                <tbody>
                                <?php if(empty($payInfos)): ?><tr>
                                        <td colspan="9">暂无数据</td>
                                    </tr><?php endif; ?>
                                <?php if(is_array($payInfos)): $i = 0; $__LIST__ = $payInfos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    <td style="vertical-align: middle"><?php echo ($tag["id"]); ?></td>
                                    <td style="vertical-align: middle"><?php echo ($tag["name"]); ?></td>
                                    <td style="vertical-align: middle"><?php echo ($tag["account"]); ?></td>
                                    ...
                                    <td style="vertical-align: middle">
                                        <a href="<?php echo U('admin/pay/edit', array('id' => $tag['id']));?>" class="btn btn-xs btn-success">编辑</a>
                                        <a data-href="<?php echo U('admin/pay/remove', array('id' => $tag['id']));?>" data-toggle="modal" data-target="#myModal" class="btn btn-danger btn-xs deleteBtn">删除</a>
                                    </td>
